  ...
  return (
    <AnimatePresence mode="wait">
      <main className="space-y-20">
        <section
          id="company-profile"
          className="container mx-auto space-y-20 px-5 py-20">
          ...
          <motion.div
            ...
            transition={linear}>
            <p>
              Sunny Foods Inc. is a provider of premium-quality meat products
              crafted through advanced processing and responsible sourcing.{" "}
              <strong>
                We are committed to excellence, sustainability, and delivering
                dependable service to both retail and wholesale customers.
              </strong>
            </p>

            <p>
              <strong>
                We specialize in premium beef processing with a strong focus on
                quality, consistency, and customer satisfaction.{" "}
              </strong>
              Our product selection includes Wagyu-style beef cubes, Black
              Pepper Steaks, Burger Patties, and our signature Steak
              Series—Strip Loin, Chuck Eye, Rib Eye, and Top Blade. Every cut is
              designed to deliver exceptional taste, tenderness, and
              convenience.
            </p>

            <p>
              With a team driven by passion and precision, we ensure that every
              product meets the highest standards and every customer receives
        ...
        <section id="mission-vision" className="space-y-20">
          <article
            ...
            <motion.div
              ...
              <p className="text-justify text-lg text-gray-700 md:text-xl">
                Sunny Foods Inc. is a leading meat processing and distribution
                company based in the Philippines. Established in 2024, we
                specialize in producing high-quality meat products using
                cutting-edge technology and strict quality control standards.
              </p>

              <p className="text-justify text-lg text-gray-700 md:text-xl">
                From our state-of-the-art manufacturing facility in Carmona,
                Cavite, we supply retailers, foodservice businesses,
                distributors, and private label clients throughout the nation,
                with delicious and affordable protein solutions.
              </p>
            </motion.div>
          ...
          <article
            ...
            <motion.div
              ...
              <p className="text-lg text-gray-700 md:text-xl">
                ...
                <strong>delicious frozen beef products,</strong> crafted to
                bring <strong>gourmet flavors and premium</strong> dining
                experiences into every home and business.
              </p>
            </motion.div>
          ...
          <article
            ...
            <motion.div
              ...
              <p className="text-lg text-gray-700 md:text-xl">
                Our vision is to be the leading producer of premium frozen beef
                products, known for{" "}
                <strong>our commitment to quality, innovation,</strong> and{" "}
                <strong>exceptional taste</strong> in the local and
          ...
          <article
            ...
            <p className="mx-auto max-w-3xl px-5 text-justify text-xl text-gray-700">
              At Sunny Foods, innovation is at the heart of everything we do.
              Our Research and Development (R&D) team is constantly exploring
              new ways to improve our products, develop new cuts of meat, and
              introduce healthier options. We also focus on improving packaging,
              enhancing flavor profiles, and developing convenient meal
          ...
          <article className="relative z-10 container mx-auto space-y-10 px-5">
            ...
            <article className="mx-auto max-w-4xl space-y-3">
              <p className="text-justify text-xl leading-6 text-white">
                A Premium quality, consistency, and convenience in every cut.
                Whether you're a chef, restaurateur, hotel operator, or
                retailer, partnering with Sunny Foods Inc. means choosing
                dependable, premium-quality beef crafted for performance and
                consistency.
              </p>
            </article>
        ...
        <header data-aos="fade-up" className="space-y-3 text-center">
          ...
          <p className="mx-auto max-w-3xl px-5 text-justify text-lg text-gray-700">
            ...
            experience in the meat processing and food production sectors. Led
            by our CEO, Mr. Li Wei Heng, who has a strong background in both
            business management and food safety, our team ensures that Sunny
            Foods stays ahead of industry trends and continues to deliver
        ...
        <section
          id="team"
          className="bg-base-300 container mx-auto my-20 sm:rounded-2xl">
