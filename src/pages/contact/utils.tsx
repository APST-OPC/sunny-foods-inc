...
export const contactBtns: IContactButton[] = [
  ...
  {
    contactIcon: ({ size, color }) => <AiOutlineFacebook size={size} color={color} />,
  ...
  {
    contactIcon: ({ size, color }) => <PiTiktokLogo size={size} color={color} />,
    contactCTA: 'Follow us on TikTok',
    openWindow: () => window.open('https://www.tiktok.com/@sunnyfoodsinc', '_blank'),
  },
  {
    contactIcon: ({ size, color }) => <AiOutlineLinkedin size={size} color={color} />,
