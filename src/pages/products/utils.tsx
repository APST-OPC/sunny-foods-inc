...
export const products: IProducts[] = [
  {
    ...
    description:
      "Tender beef steak seasoned with cracked black pepper for bold flavor.",
  ...
  },
  {
    ...
    description:
      "Warbled beef cubes ideal for grilling, stir-frying, and premium dishes.",
    image: WagyuCubes,
    type: "Core Products",
  ...
  },
  {
    ...
    description:
      "Tender and flavorful, a classic choice for grilling or pan-searing.",
  ...
  },
  {
    ...
    title: "Burger Patty",
    description:
      "Juicy beef patties for burgers, sandwiches and creative dishes.",
    image: BurgerPatty,
    type: "Core Products",
    tags: ["Cook From Frozen", "Easy to Cook", "No Chef Needed"],
  },
  ...
  },
  {
    ...
    description:
      "Lean and tender, ideal for grilling, broiling, or pan-frying.",
    image: TopBladeSteak,
    type: "Steak Series",
    tags: ["Frozen", "Easy to Cook"],
  },
