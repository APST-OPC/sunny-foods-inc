  ...
  return (
    <div className="group card relative cursor-pointer overflow-hidden rounded-none">
      <figure className="relative aspect-square w-full overflow-hidden bg-stone-300">
        ...
        />
        <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 bg-black/70 p-6 text-white opacity-0 transition-opacity duration-300 ease-in-out group-hover:opacity-100">
