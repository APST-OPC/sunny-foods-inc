...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#f6ede3]">
      <div className="container mx-auto flex flex-col items-center justify-between gap-10 px-6 pt-12 pb-6 md:flex-row lg:items-start">
        {/* Brand Section */}
        <div className="flex items-center gap-4 text-neutral-900">
          <img src={Logo} className="lg:h-28 lg:w-28 h-20 w-20" />
